...
function ticketApi() {
  fetch(
    "https://app.ticketmaster.com/discovery/v2/events.json?classificationName=music&city=" + city + "&apikey=LUhaSTXpgoB5GJGYIsUgEU0Nq5yjfC78"
  )
    .then(function (response) {
      return response.json();
    })
...
function weather() {
  fetch(
    "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=imperial&appid=f9b6ea43279bd22f926c1e54b46af35a"
  )
    .then(function (response) {
      return response.json();
    })
